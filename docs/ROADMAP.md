...
**Estado global:** Bloque 1 cerrado · Bloque 2 en progreso (9/11)
...
### Bloque 2 — Shell de partida (Conductor + Pública) 🔄 EN PROGRESO (9/11)
| 2 | Shell de partida (Conductor + Pública) | EN PROGRESO | 9/11 | — | — |
...
**Paso 2.4c en preparación (marquee + próximo desafío).**
