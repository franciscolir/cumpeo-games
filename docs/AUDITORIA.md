...
| 133 | Pictionary no migrado a accionesConductor. El bonus (2 inputs + 2 botones por equipo) no se puede expresar con el contrato actual. Además, los e2e están rotos por #122. Se resuelve en 8.5d (extender contrato o arreglar e2e primero). | Paso 8.5c.2a (detectado) | Media |
