...
| 128 | QPEP (`QuePiensaElPublicoGameUI`) no migró a `accionesConductor`: 8.5a migró Trivia y 8.5b.1 migró Anti-Trivia, Canción Incompleta, Enlaces e Historia Enredada (D2); QPEP quedó fuera de ambos pasos. Sigue en `renderizarPanelConductor` legacy; migrar en 8.5b.2 o 8.7. | Paso 8.5b.1 (detectado) | Media |
