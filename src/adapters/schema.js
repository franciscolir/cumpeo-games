...
export const STORES = [
  ...
  },
  {
    ...
    indexes: [
      ...
      { name: 'participante_partida_session_token', keyPath: 'session_token', unique: true }
    ]
  },
  {
    nombre: 'extra_usos',
  ...
  {
    nombre: 'respuestas_encuesta',
    keyPath: 'id',
    indexes: [
      { name: 'respuesta_encuesta_juego_ejecutado_id', keyPath: 'juego_ejecutado_id', unique: false },
