/* =============================================================
   0007 — Funciones plpgsql: Set.
   Creación completa de sets con item_sets atómicos.
   ============================================================= */

-- ============================================================
-- crear_set_completo — crea set + item_sets
-- ============================================================
...
BEGIN
  ...
  INSERT INTO sets (id, juego_id, nombre, descripcion, version, activo)
  VALUES (v_set_id, p_juego_id, p_nombre, p_descripcion, 1, true);
